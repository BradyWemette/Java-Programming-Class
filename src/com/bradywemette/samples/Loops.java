...
public class Loops {
	...
	public static void main(String[] args) {
		...
		/*
		 * Looping control structures (also known as 'iteration') allows you to repeat a
		 ...
		 * 
		 * while(boolean expression){ // keep running this code block until the the
		 ...
		 *
		 * do{ // code to run }while(boolean expression);
		 */
		 ...
		 * keepLooping = false;
		 * 
		 * do { System.out.println("Can I have a cake?"); } while (keepLooping);
		 */
		/*
		 * FOR LOOPS - for loops are not controlled by a boolean expression, instead
		 * there is some sort of counter
		 *
		 * for(counter start value; boolean expression; counter incrementer){ // this
		 * code runs for each loop (iteration) }
		 *
		 * NOTE THAT THE BOOK USES FOR LOOPS W/O CURLY BRACES!!!!!!!! ALSO NOTE THAT
		 * COUNTERS USE THE INCREMENT/DECREMENT OPERATORS
		 */
		// STEP 3
		...
		/*
		 * for (int z = 3; z > 0; z--) { System.out.println(z); }
		 */
		...
		// STEP 6
		// The 'break' statement
		// You can terminate a loop before it completes all of its iterations by using
		// the break statement
		// Ask the user to enter a number from 1 to 10
		// Then write a loop that will start at 1 an add all numbers up until input
		...
		// able to use it anywhere after the loop completes (actually you wont be able
		// to use it
		// any where except for the body of the loop.
		// In the example below, we say that the myStr variable is 'local' to the body
		// of the loop

		/*
		 * for (counter = 0; counter < endIndex; counter++) { String myStr = "hello"; }
		 * 
